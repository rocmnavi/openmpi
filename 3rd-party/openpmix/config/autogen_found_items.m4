...
dnl
dnl Generated by ec2-user at Mon Jul 22 23:24:00 2024
dnl on ip-172-31-2-185.us-west-2.compute.internal.
dnl ---------------------------------------------------------------------------
...
m4_define([mca_pmix_framework_list], [bfrops, gds, pcompress, pdl, pfexec, pgpu, pif, pinstalldirs, plog, pmdl, pnet, preg, prm, psec, psensor, psquash, pstat, pstrg, ptl])
...
dnl Components in the pmix / pgpu framework
m4_define([mca_pmix_pgpu_m4_config_component_list], [amd, intel, nvd])
m4_define([mca_pmix_pgpu_no_config_component_list], [])
...
m4_define([mca_pmix_pmdl_no_config_component_list], [mpich, ompi, oshmem])

dnl Components in the pmix / pnet framework
m4_define([mca_pmix_pnet_m4_config_component_list], [nvd, opa, simptest, sshot, tcp, usnic])
...
dnl Components in the pmix / prm framework
m4_define([mca_pmix_prm_m4_config_component_list], [alps, hpesmf, pbs, slurm])
m4_define([mca_pmix_prm_no_config_component_list], [default])
...
dnl Components in the pmix / pstrg framework
m4_define([mca_pmix_pstrg_m4_config_component_list], [lustre])
m4_define([mca_pmix_pstrg_no_config_component_list], [vfs])
...
m4_include([src/mca/pgpu/amd/configure.m4])
m4_include([src/mca/pgpu/intel/configure.m4])
m4_include([src/mca/pgpu/nvd/configure.m4])
...
m4_include([src/mca/pnet/nvd/configure.m4])
m4_include([src/mca/pnet/opa/configure.m4])
m4_include([src/mca/pnet/simptest/configure.m4])
m4_include([src/mca/pnet/sshot/configure.m4])
m4_include([src/mca/pnet/tcp/configure.m4])
m4_include([src/mca/pnet/usnic/configure.m4])
m4_include([src/mca/prm/alps/configure.m4])
m4_include([src/mca/prm/hpesmf/configure.m4])
m4_include([src/mca/prm/pbs/configure.m4])
m4_include([src/mca/prm/slurm/configure.m4])
...
m4_include([src/mca/pstrg/lustre/configure.m4])
