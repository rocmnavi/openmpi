...
dnl
dnl Generated by ec2-user at Wed Dec 20 22:07:11 2023
dnl on ip-172-31-2-213.us-west-2.compute.internal.
dnl ---------------------------------------------------------------------------
...
m4_define([mca_pmix_framework_list], [common, bfrops, gds, pcompress, pdl, pfexec, pgpu, pif, pinstalldirs, plog, pmdl, pnet, preg, prm, psec, psensor, pshmem, psquash, pstat, pstrg, ptl])
...
m4_define([mca_pmix_gds_m4_config_component_list], [ds12, ds21])
m4_define([mca_pmix_gds_no_config_component_list], [hash])
...
m4_define([mca_pmix_pgpu_m4_config_component_list], [])
...
m4_define([mca_pmix_pmdl_no_config_component_list], [ompi, oshmem])

dnl Components in the pmix / pnet framework
m4_define([mca_pmix_pnet_m4_config_component_list], [opa, simptest])
...
m4_define([mca_pmix_prm_m4_config_component_list], [slurm])
...
m4_define([mca_pmix_pstrg_m4_config_component_list], [])
m4_define([mca_pmix_pstrg_no_config_component_list], [])
...
m4_include([src/mca/gds/ds12/configure.m4])
m4_include([src/mca/gds/ds21/configure.m4])
